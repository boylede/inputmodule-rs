...
#[cfg(any(feature = "b1display",feature = "c1minimal",feature = "ledmatrix"))]
...
trait ControllableModule {
    fn parse_command(count: usize, buf: &[u8]) -> Option<Command>;
}

#[cfg(any(feature = "b1display",feature = "c1minimal",feature = "ledmatrix"))]
fn parse_command<M: ControllableModule>(count: usize, buf: &[u8]) -> Option<Command> {
